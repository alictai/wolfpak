function heatmap(){
  ...
  var margin = { top: ($("#overlay_div").height() * 0.05), right: ($("#overlay_div").width() * 0.1), bottom: ($("#overlay_div").height() * 0.05), left: ($("#overlay_div").width() * 0.1) },
      width = ($("#overlay_div").width() * 1.0) - margin.left - margin.right,
      height = ($("#overlay_div").height() * 0.9) - margin.top - margin.bottom,
